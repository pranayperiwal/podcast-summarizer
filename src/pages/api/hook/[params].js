...
export default async function handler(req, res) {
  ...
  try {
    ...
    await saveTranscriptToS3(hashValue + "-transcript", transcriptFile);
      ...
      messages: [
        {
          role: "system",
          content:
            "You are a podcast summariser. You will be given a chapter of the podcast. No need to mention the chapter name. Give a concise summary of the chapter.",
        },
